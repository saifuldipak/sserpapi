...
class Services(Base):
    ...
    contacts = relationship('Contacts', back_populates='services', cascade='all, delete-orphan')
    addresses = relationship('Addresses', back_populates='services', cascade='all, delete-orphan')
